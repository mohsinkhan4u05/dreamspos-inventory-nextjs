...
import { customerService, productService, storeService, salesOrderService } from "@/services/api";
...
export default function SalesOrderAdd() {
  ...
  const [expectedShipmentDate, setExpectedShipmentDate] = useState<Date | null>(null);
  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        // Auto-select a default store so the user doesn't have to pick one explicitly
  ...
  const buildPayload = (status: "DRAFT" | "CONFIRMED") => {
    ...
    // Safety check: storeId should be auto-selected from available stores
    if (!storeId) {
            ...
            <div className="card-body pb-0">
                ...
                <div className="col-lg-4 col-sm-6 col-12">
                  <div className="mb-3">
                    ...
                    <Select
                      ...
                      onChange={(opt) => setCustomerId(opt ? (opt as Option).value : "")}
                ...
                <div className="col-lg-4 col-sm-6 col-12">
                  <div className="mb-3">
                    ...
                    <div className="input-groupicon calender-input">
                      <DatePicker
                        className="form-control datetimepicker"
                        value={expectedShipmentDate ? dayjs(expectedShipmentDate) : null}
                        onChange={(value: any) =>
                              ...
                              <Select
                                ...
                                formatOptionLabel={(option) => {
                                  ...
                                  if (typeof o.unitPrice === "number") {
                                    details.push(`Rate: ${formatCurrencyINR(o.unitPrice)}`);
                                  }
              ...
              <div className="text-end">
                <button
                  ...
                  onClick={() => router.push(route.salesorders || "/sales-orders")}
                >
                  Cancel
                </button>
                <button
