...
export default function VariantAttributesComponent() {
    const data = variantattributesdata;

    const columns = [
      {
        title: "Variant",
        dataIndex: "variant",
        sorter: (a:any, b:any) => a.variant.length - b.variant.length,
      },
      {
        title: "Values",
        dataIndex: "values",
        sorter: (a:any, b:any) => a.values.length - b.values.length,
      },
