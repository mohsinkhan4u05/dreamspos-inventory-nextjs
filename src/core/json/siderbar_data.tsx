...
export const SidebarData = [
  ...
  },
  {
    ...
    submenuItems: [
      ...
      //       showSubRoute: false,
      //     },
      //     { label: "Add Sales", link: route.salesorderadd, showSubRoute: false },
      //     {
      //       label: "Add Sales (POS Style)",
      //       link: route.salesorderadd2,
      //       showSubRoute: false,
      //     },
      //   ],
  ...
  // },
  {
    ...
    submenuItems: [
      ...
      },
      {
        ...
        link: route.purchaseorderreport,
        icon: "file-unknown",
        showSubRoute: false,
        submenu: false,
      },
      ...
      {
        label: "Purchase Receives (GRN)",
        link: route.purchasereceives,
        icon: "file-download",
        showSubRoute: false,
        submenu: false,
      },
